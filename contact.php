					...
					<form role="form" action="contact.php" method="post">
						<div class="row form-group">
							<div class="col-md-6">
								...
								<input type="text" name="InputName" class="form-control" placeholder="Your firstname">
							</div>
							<div class="col-md-6">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" name="InputMob" class="form-control" placeholder="Your Mobile Number">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<textarea name="InputMessage" id="message" cols="30" rows="10" class="form-control" placeholder="Write us something"></textarea>
							</div>
						</div>
